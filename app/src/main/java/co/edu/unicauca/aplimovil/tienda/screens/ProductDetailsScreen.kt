...
@Composable
fun ProductoDetallesScreen(productId: String, productList: List<Producto>, onBack: () -> Unit) {
        ...
        LazyColumn(modifier = Modifier.fillMaxSize().background(Color.Black)) {
            ...
            item {
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(text = producto.nombre, fontSize = 24.sp, fontWeight = FontWeight.Bold, color = Color.White)
                    Text(text = "$${producto.precio}", fontSize = 20.sp, fontWeight = FontWeight.Bold, color = Color(0xFF7B5CF0))
...
fun PreviewProductoDetallesScreen(){
    val productList = listOf(
        Producto(1, "Producto 1", 100.0, R.drawable.ic_usuario),
        Producto(2, "Producto 2", 200.0, R.drawable.ic_usuario)
    )
